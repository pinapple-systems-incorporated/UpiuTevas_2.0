...
//    public WaterBodyComposition getObject() {
//        WaterBodyComposition wbc = new WaterBodyComposition();
//        wbc.id=id;
//        wbc.monoRoute=monoRoute;
//        wbc.wb1=wb1;
//        wbc.wb2=wb2;
//        wbc.wb3=wb3;
//        wbc.wb4=wb4;
...
//    }
    ...
    public String toString() {
        return "WaterBodyComposition{" + "id=" + id + ", monoRoute=" + monoRoute + ", wb1=" + wb1 + ", wb2=" + wb2 + ", wb3=" + wb3 + ", wb4=" + wb4 + ", wb5=" + wb5 + ", wb6=" + wb6 + ", wb7=" + wb7 + ", wb8=" + wb8 + ", wb9=" + wb9 + ", wb10=" + wb10 + '}';
    }
