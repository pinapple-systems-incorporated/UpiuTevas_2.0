...
@NamedQueries({
    ...
    , @NamedQuery(name = "Sleeping.findByIsntFree", query = "SELECT s FROM Sleeping s WHERE s.isntFree = :isntFree")
    , @NamedQuery(name = "Sleeping.findByOpenCamping", query = "SELECT s FROM Sleeping s WHERE s.openCamping = :openCamping")
...
public class Sleeping implements Serializable {
    ...
    @Column(name = "isnt_free")
    private Boolean isntFree;
    @Column(name = "open_camping")
    private Boolean openCamping;
    @Column(name = "bed")
    private Boolean bed;
    ...
    public Boolean getIsntFree() {
        return isntFree;
    }

    public void setIsntFree(Boolean isntFree) {
        this.isntFree = isntFree;
    }

    public Boolean getOpenCamping() {
        return openCamping;
    }

    public void setOpenCamping(Boolean openCamping) {
        this.openCamping = openCamping;
    }
